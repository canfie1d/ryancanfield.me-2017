  ...
  render() {
    return (
            <main className='page__content page__content--p-width'>
                <p className='page__p'>
                  I specialize in user interface design & front-end development. Upon completing my bachelors of fine arts in graphic design in 2012 I began working as a graphic designer for the <a target='_blank' href='http://www.azstatefair.com' className='page__inline-a'>Arizona State Fair</a> in Phoenix, AZ.
                  In October of 2013, I began a new position as a UI Engineer at <a target='_blank' href='http://www.synapsestudios.com' className='page__inline-a'>Synapse Studios</a>.
                  After moving to Seattle, WA in May of 2016. I began working for <a target='_blank' href='http://helpfulhuman.com' className='page__inline-a'>Helpful Human</a> in the same position.
                </p>
                <p className='page__p'>
